...
include 'database.php';
                                    ...
                                    if($res23){
                                      while($rows = mysqli_fetch_assoc($res23)){
                                        ...
                                        $query123 = "SELECT COUNT(productname) FROM cart where username = '$username'";
                        ...
                        <div class="container">
                            <div class="product-gallery-carousel owl-carousel owl-full owl-nav-dark">
                                <figure class="product-gallery-image">
                                  	...
                                  	<?php echo('<img src="Admin/'.$locationnew.'"  alt="product image">'); ?>
                                ...
                                <div class="col-md-6">
                                    <div class="product-details-action">
                                        <div class="details-action-col">
                                            <a href="addtochart.php?productid= <?php echo $id; ?>"class="btn-product btn-cart"><span>add to cart</span></a>
                                        </div><!-- End .details-action-col -->
                                        <div class="details-action-col">
                                            <a href="checkout.php?productid= <?php echo $id; ?>" class="btn-product btn-cart  btn-primary text-white w-100"><span>CHECKOUT</span></a>
                                        </div>
						...
						<table class="table">
                            ...
                            <div class="tab-pane fade" id="product-shipping-tab" role="tabpanel" aria-labelledby="product-shipping-link">
                                <div class="product-desc-content">
                                    ...
                                    <p>We deliver to over 10 districts around UGANDA. For full details of the delivery options we offer, please view our <a href="#">Delivery information</a><br>
...
<div class="product product-7 text-center">
  ...
  <a href="product_deal.php?productid='.$idl.'">  <img src="Admin/'.$locationl.'" alt="Product image" class="product-image"></a>        </a>

        <div class="product-action-vertical">

    <a href="addtochartdeal.php?productid='.$idl.'" class="btn-product-icon btn-wishlist btn-expandable"><span>add to chart</span></a>
        </div><!-- End .product-action-vertical -->

        <div class="product-action">
          <a href="addtochartdeal.php?productid='.$idl.'" class="btn-product btn-cart"><span>add to cart</span></a>
