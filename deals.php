    ...
    <div class="product">
        <figure class="product-media">
            ...
            <div class="product-action-vertical">
                <a href="addtochartdeal.php?productid='.$id.'" class="btn-product-icon btn-wishlist btn-expandable"><span>add to cart</span></a>
            </div><!-- End .product-action -->

            <div class="product-action action-icon-top">
                <a href="addtochartdeal.php?productid='.$id.'"class="btn-product btn-cart"><span>add to cart</span></a>
                <a href="product_deal.php?productid='.$id.'"class="btn-product btn-cart"><span>view details</span></a>
...
';
                        ...
                        <div class="load-more-container text-center">
                            <a href="category.php" class="btn btn-outline-darker btn-load-more">More Products <i class="icon-refresh"></i></a>
