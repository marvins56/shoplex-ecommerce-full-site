...
>
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item lh-1 me-3">
                  <a
                    class="github-button"
                    href="https://github.com/marvins56"
                    data-icon="octicon-star"
                    data-size="large"
                    data-show-count="true"
                    aria-label="find more on GitHub"
                    >Star</a
                  >
                </li>
  ...
  $res = mysqli_num_rows($sql);
                      ...
                      ?>
                      <?php echo('<img src="'.$location.'" alt class="w-px-40 h-auto rounded-circle" />'); ?>
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li>
                      <a class="dropdown-item" href="#">
                        <i class="bx bx-user me-2"></i>
                        <span class="align-middle" data-bs-toggle="offcanvas"
                          data-bs-target="#offcanvasBackdrop"
                          aria-controls="offcanvasBackdrop">
                      ...
                      <div class="mt-3">
                        ...
                        >
                          <div class="offcanvas-header">
                            <h5 id="offcanvasBackdropLabel" class="offcanvas-title text-uppercase"><?php echo $username; ?> PROFILE</h5>
                            <button
                              type="button"
      ...
      <div class="misc-wrapper">
        <h2 class="mb-2 mx-2">UNDER DEVELPMENT!</h2>
        <p class="mb-4 mx-2">Sorry for the inconvenience but we're Improving the system at the moment</p>
