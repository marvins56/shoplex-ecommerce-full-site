<?php include 'login_head.php' ?>
        <main class="main">
        	...
        	<div class="error-content text-center" >
            	<div class="container">
            <img  class="img-fluid" style="width:50%;margin:auto;"src="tf.gif" alt="">
            		<h1 class="error-title">Error !!!!</h1><!-- End .error-title -->
            		<p>We are sorry, this paymnt has FAILED or timed out.</p>
    ...
    <div class="mobile-menu-container">
        <div class="mobile-menu-wrapper">
            ...
            <form action="search.php" method="post" class="mobile-search">
                ...
                <input type="search" name="search" class="form-control" name="mobile-search" id="mobile-search" placeholder="Search in..." required>
