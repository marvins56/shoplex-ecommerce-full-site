...
window.setTimeout(function() {
 ...
 <script async src="https://api.countapi.xyz/hit/shoplexug.42web.io/2bcd794a-aaa4-4f39-9483-b582ba912676?callback=websiteVisits"></script>
</head>
  ...
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="../../index.php">
        ...
        <span class="ms-1 font-weight-bold text-white">ShOpLeXUG </span>
      </a>
    </div>
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white " href="" target="_blank">
            <div class="text-white text-center me-2 d-flex align-items-center justify-content-center">
              <i class="material-icons opacity-10">website</i>
            </div>
