...
if(isset($_POST['deals'])){
  ...
  $query = "UPDATE deals SET id = '$id',productname = '$productname', price = '$price',
  description = '$description',discount = '$discount',name ='".$name."', location='".$target_file."', category ='$category' where id ='$id'";
    ...
    <div class="card-body">
      <form role="form" method="post" enctype="multipart/form-data">
        ...
        <div class="input-group input-group-outline mb-3">
          ...
          <input type="text " class="form-control text-white" name="description"  value="<?php echo $description; ?>" autocomplete="off">
        </div>
        <div class="input-group input-group-outline mb-3">
        ...
        <div class="text-center">
          <input type="submit" name="deals"  value="update" class="btn btn-lg bg-gradient-primary btn-lg w-100 mt-4 mb-0">
        </div>
      </form>
    </div>
        </div>
