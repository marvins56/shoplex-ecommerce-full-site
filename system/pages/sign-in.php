   ...
   ShOpLeXUG
            ...
            <div class="collapse navbar-collapse" id="navigation">
              ...
              <ul class="navbar-nav d-lg-block d-none">
                <li class="nav-item">
                  <a href="../../index.php" class="btn btn-sm mb-0 me-1 bg-gradient-dark">home</a>
                </li>
              </ul>
            </div>
          </div>
            ...
            <div class="card z-index-0 fadeIn3 fadeInBottom">
              ...
              <div class="card-body">
                <form role="form"  method="post"class="text-start">
                 ...
                 <input type="submit" name="submit" value="submit" class="btn bg-gradient-primary w-100 my-4 mb-2">
                  </div>
